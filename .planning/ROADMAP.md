...
- [ ] **Phase 2: Setup Screen** - Parent configures duration + scene and launches the timer; last-used settings remembered (all plans executed; awaiting human UAT sign-off)
...
| 2. Setup Screen | 5/5 | Awaiting UAT | - |
