...
- [x] 02-02-PLAN.md — Scene selection: ScenePreviewPainter abstraction + 4 static previews + scene grid (SETUP-03)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 02-03-PLAN.md — Custom duration: accelerating hold-repeat stepper with clamped 1–120 range (SETUP-02)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 02-04-PLAN.md — Persistence: last-used preset + theme, validated on read (PERSIST-01)
...
- [x] 04-01-PLAN.md — Audio foundation: pure-Dart chime synthesizer + ChimePlayer interface/adapter + audioplayers dependency (CTRL-03)
- [x] 04-02-PLAN.md — Mute persistence: SetupPreferences.soundOn scalar with validate-on-read fallback (CTRL-02)
- [x] 04-03-PLAN.md — Decorative loop continuity fix (D-10): resume loops from frozen phase across pause/resume (CTRL-02)
...
- [ ] 05-02-PLAN.md — Icon render spike (Wave 0 gate): prove headless SunrisePainter → PNG path + reusable renderPainterToPng helper (PUBLISH-02)
...
| 5. Play Store Readiness | 0/5 | Planned | - |
